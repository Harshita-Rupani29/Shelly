    ...
    .action(async (subcommand, options) => {
      try {
        if (options.disableAi) {
          ...
          console.log(
            '✅ AI features disabled for this Shelly invocation. Shelly will use template-based generation.'
          );
          console.log(
            'ℹ️ To keep AI disabled for all future runs, set the environment variable SHELLY_AI_DISABLED=true.'
          );
          return;
        }
        ...
        if (options.enableAi) {
          ...
          console.log('✅ AI features enabled for this Shelly invocation.');
          console.log(
            'ℹ️ If you previously set SHELLY_AI_DISABLED, unset it or set it to false to enable AI for all runs.'
          );
          return;
        }
